...
@ManagedBean(name = "altClienteBacking")
@ViewScoped
public class AltClienteBacking implements Serializable {
	...
	public AltClienteBacking() {
		this.cliente = ListClienteBacking.clienteSelecionado;
		carregarTela();
	}
	...
	private void carregarCidadesAlterar() {
