...
@ManagedBean(name = "altFuncionarioBacking")
@ViewScoped
public class AltFuncionarioBacking implements Serializable {
	...
	public AltFuncionarioBacking() {
		this.funcionario = ListFuncionarioBacking.funcionarioSelecionado;
		carregarPerfil();
